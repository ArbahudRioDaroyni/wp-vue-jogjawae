          ...
          for (const name in record.components) {
              ...
              if (isRouteComponent(rawComponent)) {
                  ...
                  if ( !('catch' in componentPromise)) {
                      vue.warn(`Component "${name}" at record with path "${record.path}" is a function that does not return a Promise. If you were passing a functional component, make sure to add a "displayName" to the component. This will break in production if not fixed.`);
