...
<html>
  <head>
    ...
    <noscript><link rel="stylesheet" href="<?= get_template_directory_uri() . '/css/ionicons.min.css?ver=0.0.1' ?>"></noscript>
    ...
    <noscript><link rel="stylesheet" href="<?= get_template_directory_uri() . '/css/main.css?ver=0.0.1' ?>"></noscript>
